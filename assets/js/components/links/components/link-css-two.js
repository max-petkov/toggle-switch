...
const LinkCssTwo$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return linkCssTwoCss; }
}, [1, "link-css-two", {
...
function defineCustomElement$1() {
  ...
  const components = ["link-css-two"];
  components.forEach(tagName => { switch (tagName) {
    case "link-css-two":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LinkCssTwo$1);
      }
      break;
  } });
}

const LinkCssTwo = LinkCssTwo$1;
const defineCustomElement = defineCustomElement$1;

export { LinkCssTwo, defineCustomElement };
