...
export class PaxJsButton {
  ...
  render() {
    return (h("button", { class: "btn-pax-js", onMouseEnter: this.enterAnimation.bind(this), onMouseLeave: this.leaveAnimation.bind(this) },
      "Join",
  ...
  static get is() { return "pax-js-button"; }
