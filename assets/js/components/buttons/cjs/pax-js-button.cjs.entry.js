...
const PaxJsButton = class {
  ...
  enterAnimation() {
    ...
    const tl = index$1.gsapWithCSS.timeline({
      defaults: {
        duration: 1.5,
        ease: 'Bounce.easeOut',
      },
