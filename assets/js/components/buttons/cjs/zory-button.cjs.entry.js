...
animateZoryButton({
  ...
  render() {
    return (index.h("button", { class: "btn-zory" }, index.h("span", null, "Hover me"), index.h("div", { class: "btn-zory__circles-wrapper" }, index.h("div", { class: "circle circle--1" }), index.h("div", { class: "circle circle--2" }))));
  }
  get el() { return index.getElement(this); }
};
ZoryButton.style = zoryButtonCss;

exports.zory_button = ZoryButton;
