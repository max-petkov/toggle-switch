...
const ButtonCssFive$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return buttonCssFiveCss; }
}, [1, "button-css-five", {
...
function defineCustomElement$1() {
  ...
  const components = ["button-css-five"];
  components.forEach(tagName => { switch (tagName) {
    case "button-css-five":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ButtonCssFive$1);
      }
      break;
  } });
}

const ButtonCssFive = ButtonCssFive$1;
const defineCustomElement = defineCustomElement$1;

export { ButtonCssFive, defineCustomElement };
