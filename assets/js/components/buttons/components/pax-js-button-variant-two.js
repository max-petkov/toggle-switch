...
const PaxJsButtonVariantTwo$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  get el() { return this; }
  static get style() { return paxJsButtonVariantTwoCss; }
}, [1, "pax-js-button-variant-two", {
...
function defineCustomElement$1() {
  ...
  const components = ["pax-js-button-variant-two"];
  components.forEach(tagName => { switch (tagName) {
    case "pax-js-button-variant-two":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PaxJsButtonVariantTwo$1);
      }
      break;
  } });
}

const PaxJsButtonVariantTwo = PaxJsButtonVariantTwo$1;
const defineCustomElement = defineCustomElement$1;

export { PaxJsButtonVariantTwo, defineCustomElement };
