...
const MagnetButton$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h("div", { class: "magnet-wrapper" }, h("button", { class: "btn-magnet" }, "Get in touch")));
  }
  get el() { return this; }
  static get style() { return magnetButtonCss; }
}, [1, "magnet-button", {
...
function defineCustomElement$1() {
  ...
  const components = ["magnet-button"];
  components.forEach(tagName => { switch (tagName) {
    case "magnet-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MagnetButton$1);
      }
      break;
  } });
}

const MagnetButton = MagnetButton$1;
const defineCustomElement = defineCustomElement$1;

export { MagnetButton, defineCustomElement };
