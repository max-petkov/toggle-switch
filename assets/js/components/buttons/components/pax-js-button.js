...
const PaxJsButton$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return paxJsButtonCss; }
}, [1, "pax-js-button", {
...
function defineCustomElement$1() {
  ...
  const components = ["pax-js-button"];
  components.forEach(tagName => { switch (tagName) {
    case "pax-js-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PaxJsButton$1);
      }
      break;
  } });
}

const PaxJsButton = PaxJsButton$1;
const defineCustomElement = defineCustomElement$1;

export { PaxJsButton, defineCustomElement };
