...
const ButtonCssFourteen$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return buttonCssFourteenCss; }
}, [1, "button-css-fourteen", {
...
function defineCustomElement$1() {
  ...
  const components = ["button-css-fourteen"];
  components.forEach(tagName => { switch (tagName) {
    case "button-css-fourteen":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ButtonCssFourteen$1);
      }
      break;
  } });
}

const ButtonCssFourteen = ButtonCssFourteen$1;
const defineCustomElement = defineCustomElement$1;

export { ButtonCssFourteen, defineCustomElement };
