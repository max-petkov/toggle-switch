...
const PaxJsButtonVariantOne$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["pax-js-button-variant-one"];
  components.forEach(tagName => { switch (tagName) {
    case "pax-js-button-variant-one":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PaxJsButtonVariantOne$1);
      }
      break;
  } });
}

const PaxJsButtonVariantOne = PaxJsButtonVariantOne$1;
const defineCustomElement = defineCustomElement$1;

export { PaxJsButtonVariantOne, defineCustomElement };
