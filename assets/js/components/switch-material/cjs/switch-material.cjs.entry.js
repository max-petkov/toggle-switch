...
const SwitchMaterial = class {
  ...
  render() {
    return (index.h("label", { class: "switch switch--state" }, index.h("input", { type: "checkbox", onChange: this.onSwitchHandler.bind(this), ref: el => (this.checkbox = el), disabled: this.disabled }), index.h("span", { class: "slider" })));
  }
  get el() { return index.getElement(this); }
};
SwitchMaterial.style = switchMaterialCss;

exports.switch_material = SwitchMaterial;
